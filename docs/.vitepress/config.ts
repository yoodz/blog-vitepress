...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message: '本网站由<a href="https://www.upyun.com/?utm_source=lianmeng&utm_medium=referral" target="__blank"><img style="display: inline;width: 40px;transform: translateY(-1px);" src="https://upyun.afunny.top/202409202028300.webp" /></a>提供CDN加速/存储服务｜<a href="http://beian.miit.gov.cn/" style="text-decoration:none;" target="__blank">沪ICP备2026008718号</a>｜<a href="https://www.afunny.top/feed.xml" style="text-decoration:none;" target="__blank">RSS</a>',
