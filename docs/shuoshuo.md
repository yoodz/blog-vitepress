---
{
  ...
  "shuoList": [
    {
      "content": "无意间发现，现在不怎么用翻译网页了。在我的书签栏最前面一直放着一个有道翻译，刚才忽然发现，好久没有点开过他了。AI进入我的工作流程后，我很少去翻看一些英文文档了，即使有一些英文文档，AI提供的全文翻译也很好用了。终于不再需要单独的翻译网页了。这个网页有一个我一直想吐槽的点，就是每次都要手动选择当前语言和目标语言，这个完全可以根据输入算出来的吧，现在我不再使用了，居然发现它更新了这个功能，反应太慢啦。",
      "date": "2026-02-27",
      "tags": ["随想"]
    },
    {
    ...
    {
      "content": "对我来说，博客首先是一种知识管理工具，其次才是传播工具。我的技术文章，主要用来整理我还不懂的知识。我只写那些我还没有完全掌握的东西，那些我精通的东西，往往没有动力写。炫耀从来不是我的动机，好奇才是。\n\n──阮一峰",
      "date": "2024-09-15",
      "tags": ["博客"]
    }
  ]
